    ...
    return (
      <div className='flex flex-col px-4'>
        <Table className='w-full min-w-max'>
          ...
          <Thead>
            <Tr>
              <Td className='border-r bg-solid-gray-50' scope='col'></Td>
...
export const TableHeaderWithColspan: Story = {
  render: () => {
    return (
      <div className='flex flex-col px-4'>
        <Table className='w-full min-w-max border border-solid-gray-400'>
...
export const TableHeaderWithRowspan: Story = {
  render: () => {
    return (
      <div className='flex flex-col px-4'>
        <Table className='w-full min-w-max border border-solid-gray-400 [&_th]:border-r'>
          <caption className='p-4 font-bold'>1列目が見出しセル</caption>
          <Tbody>
            <Tr>
